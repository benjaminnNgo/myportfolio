...
export default function Home() {
  ...
  useEffect(() => {
    layer = Array.from(document.getElementsByClassName("layer"));
    layer.forEach((layer) => {
      speed = layer.getAttribute("data-depth");
      x = (window.innerWidth - position.x * speed) / 10;
      y = (window.innerHeight - position.y * speed) / 10;
      layer.style.transform = `translateX(${x}px) translateY(${y}px)`;
    });
  }, [position]);
  return (
    <div className="home">
      <div className="intro h-screen flex items-center text-center justify-center m-auto">
        <div>
          <motion.img
            variants={fadeDown}
            initial="hidden"
          ...
          >
            ...
            <Typewriter
              onInit={(typewiter) => {
                typewiter
                  .typeString(" a second year student ! ")
                  .pauseFor(2000)
                  .deleteAll()
          ...
          >
            <a href="https://www.instagram.com/ntg.baoo/">
              <InstagramOutlined className="social-icon" />
            </a>
            <a href="https://www.linkedin.com/in/bao-ngo-tran-gia-029784235/">
              <LinkedinOutlined className="social-icon" />
            </a>
            <a href="https://github.com/jimmNgo">
          ...
          {/* <motion.button
            ...
            whileHover={{ scale: 1.2, duration: 1 }} className='button-pink m-auto mt-6'>
            <a href='#' download='./assets/NgoTranGiaBao.docx'>Hire me</a>
