        ...
        <Carousel autoplay>
          ...
          <div className="slide-area">
            ...
            <div style={contentStyle}>
              ...
              <div className="review">
                "I believe that Bao will complete his study at the International
                College of Manitoba undoubtedly to much acclaim and perform
                spectacularly at the University of Manitoba. He is a rare and
                gifted scholar and has my strongest support."
              </div>
            </div>
          </div>
          {/* <div className="slide-area">
        ...
        <div className="container grid grid-cols-2 gap-6 md:gap-0">
          <div className=" col-span-2 md:col-span-1 timeline  ">
            ...
            <motion.div animate={animation} className="timeline-item">
              ...
              <h2 className="timeline-institution">University of Manitoba</h2>
              <ul>
                <li>First year's GPA: 4.4/4.5</li>
                <li>Manager of Peer education at ICM </li>
          ...
          <div className="skill col-span-2 md:col-span-1  ">
            ...
            <motion.div animate={animation} className="tick-part">
              <ul>
                ...
                <li>
                  <FontAwesomeIcon icon={faCheck} />
                  Knowledge about NodeJS, ExpressJS, Mongoose
                </li>
                <li>
                  <FontAwesomeIcon icon={faCheck} />
                  MongoDB
